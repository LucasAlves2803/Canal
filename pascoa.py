...
def algoritmo_de_Gauss(): 
    ...
    #print "A pascoa em {:d} sera em {:d}/{:d}/{:d}".format(ano,pascoa_ano[0][0],pascoa_ano[0][1],pascoa_ano[0][2])
...
def grafico():
    print "========== Frequência da Pascoa entre os anos de {:d} ate {:d} =============".format(ano1,ano2)
